...
const WorkoutCategoryChart = ({ workouts }) => {
  if (!workouts || workouts.length === 0) return <div className="bg-white p-4 rounded shadow">No workout data</div>;
  ...
  return (
    <div className="bg-white p-4 rounded shadow">
      <h3 className="text-xl font-semibold mb-4">Workout Categories</h3>
